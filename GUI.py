...
root.title('Tkinter.com - Magically Magic 8 Ball')
root.iconbitmap()
...
ball_button = customtkinter.CTkButton(master=root, text= "Shake the Magically Magic 8 Ball!", width= 190, height=40, compound="top", command=shake)
